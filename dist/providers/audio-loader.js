...
var AudioLoader = (function () {
    function AudioLoader(config, file, fileTransfer, platform) {
        var _this = this;
        this.config = config;
        this.file = file;
        ...
        platform.ready().then(function () {
            if (!platform.is('cordova')) {
                ...
                _this.isInit = true;
                _this.throwWarning('You are running on a browser or using livereload, IonicAudioLoader will not function, falling back to browser loading.');
            }
            else {
    ...
    Object.defineProperty(AudioLoader.prototype, "nativeAvailable", {
        get: function () {
    ...
    Object.defineProperty(AudioLoader.prototype, "shouldIndex", {
        get: function () {
    ...
    Object.defineProperty(AudioLoader.prototype, "isWKWebView", {
        get: function () {
    ...
    Object.defineProperty(AudioLoader.prototype, "isIonicWKWebView", {
        get: function () {
     ...
     */
    AudioLoader.prototype.preload = function (audioUrl) {
        return this.getAudioPath(audioUrl);
    };
    /**
     * Clears the cache
     */
    AudioLoader.prototype.clearCache = function () {
        var _this = this;
     ...
     */
    AudioLoader.prototype.getAudioPath = function (audioUrl) {
        var _this = this;
        ...
        return new Promise(function (resolve, reject) {
            var getAudio = function () {
                _this.getCachedAudioPath(audioUrl)
                    .then(resolve)
                    .catch(function () {
                    // audio doesn't exist in cache, lets fetch it and save it
                    _this.addItemToQueue(audioUrl, resolve, reject);
                });
            };
            var check = function () {
                if (_this.isInit) {
                    if (_this.isCacheReady) {
                        ...
                        _this.throwWarning('The cache system is not running. Audio files will be loaded by your browser instead.');
                        resolve(audioUrl);
                    }
                }
                else {
     ...
     * @param reject
     */
    AudioLoader.prototype.addItemToQueue = function (audioUrl, resolve, reject) {
        this.queue.push({
            audioUrl: audioUrl,
            resolve: resolve,
            reject: reject
    ...
    Object.defineProperty(AudioLoader.prototype, "canProcess", {
        /**
     ...
     */
    AudioLoader.prototype.processQueue = function () {
        var _this = this;
        ...
        var localPath = this.file.cacheDirectory + this.config.cacheDirectoryName + '/' + this.createFileName(currentItem.audioUrl);
        transfer.download(currentItem.audioUrl, localPath)
            ...
            return _this.getCachedAudioPath(currentItem.audioUrl);
        })
     ...
     * @returns {Promise<any>}
     */
    AudioLoader.prototype.addFileToIndex = function (file) {
        var _this = this;
     ...
     * @returns {any}
     */
    AudioLoader.prototype.indexCache = function () {
        var _this = this;
     ...
     */
    AudioLoader.prototype.maintainCacheSize = function () {
        var _this = this;
     ...
     */
    AudioLoader.prototype.removeFile = function (file) {
        var _this = this;
        return this.file
     ...
     */
    AudioLoader.prototype.getCachedAudioPath = function (url) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            ...
            _this.file.resolveLocalFilesystemUrl(dirPath + '/' + fileName)
                ...
                if (_this.config.audioReturnType === 'base64') {
                ...
                else if (_this.config.audioReturnType === 'uri') {
     ...
     */
    AudioLoader.prototype.throwError = function () {
        var args = [];
     ...
     * @param args {any[]} Error message
     */
    AudioLoader.prototype.throwWarning = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
     ...
     */
    AudioLoader.prototype.cacheDirectoryExists = function (directory) {
     ...
     */
    AudioLoader.prototype.createCacheDirectory = function (replace) {
        var _this = this;
     ...
     */
    AudioLoader.prototype.createFileName = function (url) {
     ...
     */
    AudioLoader.prototype.hashString = function (string) {
        var hash = 0, char;
        if (string.length === 0)
            return hash;
...
export { AudioLoader };
AudioLoader.decorators = [
    { type: Injectable },
];
/** @nocollapse */
AudioLoader.ctorParameters = function () { return [
