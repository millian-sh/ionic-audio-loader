...
export declare class AudioLoader {
    ...
    constructor(config: AudioLoaderConfig, file: File, fileTransfer: FileTransfer, platform: Platform);
    /**
     * Preload an audio
     ...
     * @param reject
     */
    private addItemToQueue(audioUrl, resolve, reject);
    /**
     ...
     */
    private getCachedAudioPath(url);
    /**
